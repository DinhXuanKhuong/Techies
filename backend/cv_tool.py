...
def predict_image(model, image_path, device):
    ...
    # return {"Predicted Label with max probability" : predicted_label, "All Probabilities": probabilities}
    return result
# if __name__ == "__main__":
#     model_path = 'best_model_final.pth'  
#     image_path = 'image.png'  # path to image
    
#     try:
#         model, device = load_model(model_path)
#         print(predict_image(model, image_path, device))
